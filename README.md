...
- There are different types: int, float, str
- Tuples are written as comma-seperated elements within parentheses

```Python
ratings = (10, 9, 8, 7, 10, 5, 4, 3, 3, 8)
review = ('str', 1.2, 10)
say_what=(99, 10, 'say',' what', 'you', 'will', 10, 1.2, 192)
plus_this=say_what + ('Snaplink Owner', 10)
```
